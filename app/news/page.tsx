...
export default function NewsPage() {
  ...
  const newsArticles = [
    ...
    },
    {
      id: 2,
      title:
        "New Research Shows AI Can Predict Protein Structures with 99% Accuracy",
      summary:
        "Breakthrough in computational biology could accelerate drug discovery and medical research.",
      date: "2025-04-02",
      readTime: "8 min read",
    ...
    },
    {
      ...
      summary:
        "New report shows 78% of small businesses now use some form of AI, up from 45% last year.",
      date: "2025-03-29",
      readTime: "7 min read",
    ...
    },
    {
      ...
      summary:
        "Novel approach significantly decreases false or misleading outputs from large language models.",
      date: "2025-03-28",
      readTime: "9 min read",
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
        ...
        <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
          Stay updated with the latest developments, breakthroughs, and trends
          in AI.
        </p>
      </div>
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        {["models", "research", "applications", "policy", "business"].map(
          (category) => (
      ...
      <div className="mt-12 p-6 bg-gray-50 rounded-lg">
        ...
        <p className="text-gray-500 mb-6">
          Get the latest AI news and trends delivered straight to your inbox.
          Choose your interests to receive personalized updates.
        </p>
